class AdminService {
  ...
  static validateUserData(userData) {
    ...
    if (!userData.matricula || userData.matricula.trim().length < 1) {
    ...
    if (!userData.cargo || userData.cargo.trim().length < 1) {
    ...
    if (userData.senha !== userData.confirma_senha) {
      errors.confirma_senha = 'Senhas não coincidem';
    }
