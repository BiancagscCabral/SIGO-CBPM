    ...
    static async criarOcorrencia(dadosFormulario) {
        try {
            ...
            if (response.ok) {
                ...
                console.error('OcorrenciasService.criarOcorrencia - servidor retornou erro:', errorText);
    ...
    static async listarOcorrencias() {
        try {
            ...
            if (response.ok) {
                ...
                const errorText = await response.text();
                console.error('OcorrenciasService.listarOcorrencias - servidor retornou erro:', errorText);
                return {
                    success: false,
                    error: errorText,
    ...
    static async listarTodasOcorrencias() {
        try {
            ...
            if (response.ok) {
                ...
                const errorText = await response.text();
                console.error('OcorrenciasService.listarTodasOcorrencias - servidor retornou erro:', errorText);
                return {
                    success: false,
                    error: errorText,
    ...
    static async buscarOcorrenciaPorId(id) {
        try {
            ...
            if (response.ok) {
                ...
                const errorText = await response.text();
                console.error('OcorrenciasService.buscarOcorrenciaPorId - servidor retornou erro:', errorText);
                return {
                    success: false,
                    error: errorText,
